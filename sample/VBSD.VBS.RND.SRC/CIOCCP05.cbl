      ...
      *                     THRU 3020-APPLID-CHECK-EXIT                 01651212
       ...
       3000-MAIN-PROCESS-EXIT.                                          01900000
            EXIT.                                                       01910000
      *                                                                 01920000
       3010-CHECK-INPUT.*>IMPORTANT                                                01930000
      ...
      *                                                                 02160000
       3010-CHECK-INPUT-EXIT.                                           02170000
            EXIT.                                                       02180000
      *                                                                 02190000
       3020-APPLID-CHECK.*>IMPORTANT                                               02200006
      ...
      *                                                                 02660000
       3020-APPLID-CHECK-EXIT.                                          02670006
            EXIT.                                                       02680000
      *                                                                 02680119
       3021-PROD-CARD.*>IMPORTANT                                                  02680219
      ...
      *                                                                 02683419
       3021-PROD-CARD-EXIT.                                             02683519
            EXIT.                                                       02683619
      *                                                                 02683706
       3022-ACCT-ADD.*>IMPORTANT                                                   02683819
      ...
      *                                                                 02687018
       3022-ACCT-ADD-EXIT.                                              02688219
            EXIT.                                                       02688317
      *                                                                 02692000
       3023-UPDATE-STETUS.*>IMPORTANT                                              02692115
